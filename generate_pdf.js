...
function buildUniversalPdf() {
    ...
    const streamBody = [
        ...
        "/F1 14 Tf",
        "35 750 Td",
        "(RUMUS PERPANGKATAN UNIVERSAL 4.0: PUBLIKASI IEEE SCOPUS Q1) Tj",
        "0 -18 Td",
        "/F2 10 Tf",
        ...
        "0 -14 Td",
        "/F2 9 Tf",
        "(Makalah ilmiah ini menyajikan formulasi analitis eksak untuk Rumus Perpangkatan Universal 4.0) Tj",
        "0 -12 Td",
        "(karya Samuel Hasiholan Omega, S. Tr. T. Persamaan deret binomial ini menjamin ekuivalensi) Tj",
        "0 -12 Td",
        "(sempurna dengan garansi presisi 100 persen dan terbebas dari pembagian dengan nol.) Tj",
        "0 -12 Td",
        ...
        "0 -14 Td",
        "/F2 9 Tf",
        "(1. Persamaan Kompleks Utama: Penjabaran suku berpangkat n dari pengurangan x dan y) Tj",
        "0 -12 Td",
        "(   mengikuti deret kombinatorika Newton dengan perkalian minus satu pangkat k.) Tj",
        "0 -12 Td",
        "(2. Turunan Parsial Terhadap y: Turunan parsial dari bentuk (x - y) pangkat n terhadap y) Tj",
        "0 -12 Td",
        "(   menghasilkan nilai minus n dikali (x - y) pangkat (n - 1).) Tj",
        "0 -12 Td",
        "(3. Asimptotik Limit Invariansi: Rasio batas limit x mendekati tak hingga bernilai tepat) Tj",
        "0 -12 Td",
